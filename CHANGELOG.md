### Features
  ...
  - Exposed `raster_runtime:qjs` module (@nabetti1720)
...
This changelog entry comes from the upstream LLRT history before the
raster_runtime fork. Future changelog entries should describe Raster-specific
changes.
