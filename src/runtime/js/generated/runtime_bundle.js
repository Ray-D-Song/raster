globalThis.__rasterRendererVersion = globalThis.__rasterRendererVersion ?? "0.1.0";
"use strict";
var __RasterBundle = (() => {
  ...
  // ../../node_modules/.pnpm/react-reconciler@0.33.0_react@19.2.6/node_modules/react-reconciler/cjs/react-reconciler.production.js
  var require_react_reconciler_production = __commonJS({
    "../../node_modules/.pnpm/react-reconciler@0.33.0_react@19.2.6/node_modules/react-reconciler/cjs/react-reconciler.production.js"(exports, module) {
      "use strict";
      module.exports = function($$$config) {
        ...
        function popHostContext(fiber) {
          ...
          hostTransitionProviderCursor.current === fiber && (pop(hostTransitionProviderCursor), isPrimaryRenderer ? HostTransitionContext2._currentValue = NotPendingTransition2 : HostTransitionContext2._currentValue2 = NotPendingTransition2);
        }
          ...
          switch (workInProgress2.tag) {
            ...
            case 5:
              ...
              null !== workInProgress2.memoizedState && ($$typeof = renderWithHooks(
                ...
                null,
                renderLanes2
              ), isPrimaryRenderer ? HostTransitionContext2._currentValue = $$typeof : HostTransitionContext2._currentValue2 = $$typeof);
              markRef(current, workInProgress2);
        ...
        var NotPendingTransition2 = $$$config.NotPendingTransition, HostTransitionContext2 = $$$config.HostTransitionContext, resetFormInstance = $$$config.resetFormInstance;
  ...
  // ../../node_modules/.pnpm/react-reconciler@0.33.0_react@19.2.6/node_modules/react-reconciler/index.js
  var require_react_reconciler = __commonJS({
    "../../node_modules/.pnpm/react-reconciler@0.33.0_react@19.2.6/node_modules/react-reconciler/index.js"(exports, module) {
      "use strict";
      if (true) {
  ...
  // ../../node_modules/.pnpm/react-reconciler@0.33.0_react@19.2.6/node_modules/react-reconciler/cjs/react-reconciler-constants.production.js
  var require_react_reconciler_constants_production = __commonJS({
    "../../node_modules/.pnpm/react-reconciler@0.33.0_react@19.2.6/node_modules/react-reconciler/cjs/react-reconciler-constants.production.js"(exports) {
      "use strict";
  ...
  // ../../node_modules/.pnpm/react-reconciler@0.33.0_react@19.2.6/node_modules/react-reconciler/constants.js
  var require_constants = __commonJS({
    "../../node_modules/.pnpm/react-reconciler@0.33.0_react@19.2.6/node_modules/react-reconciler/constants.js"(exports, module) {
      "use strict";
      if (true) {
  ...
  var require_react_jsx_runtime_production = __commonJS({
    "../../node_modules/.pnpm/react@19.2.6/node_modules/react/cjs/react-jsx-runtime.production.js"(exports) {
      "use strict";
      var REACT_ELEMENT_TYPE = /* @__PURE__ */ Symbol.for("react.transitional.element");
      var REACT_FRAGMENT_TYPE = /* @__PURE__ */ Symbol.for("react.fragment");
  ...
  var runtime_bundle_exports = {};
  __export(runtime_bundle_exports, {
    Activity: () => import_react4.Activity,
    Alert: () => Alert,
    AreaChart: () => AreaChart,
    Avatar: () => Avatar,
    ...
    Component: () => import_react4.Component,
    ...
    Sheet: () => Sheet,
    Slot: () => Slot,
    Suspense: () => import_react4.Suspense,
    Switch: () => Switch,
    Tab: () => Tab,
    TabBar: () => TabBar,
    Text: () => Text,
    ...
    createRasterRoot: () => createRoot,
    createRoot: () => createRoot,
    jsx: () => import_jsx_runtime3.jsx,
    jsxs: () => import_jsx_runtime3.jsxs,
    notification: () => notification,
    useEffect: () => import_react4.useEffect,
    useRef: () => import_react4.useRef,
    useState: () => import_react4.useState
  });
  ...
  // src/core/raster-core.ts
  var rasterGlobal = globalThis;
  var handlers = /* @__PURE__ */ new Map();
  var handlerSlots = /* @__PURE__ */ new Map();
  var RASTER_NATIVE_NODE_TYPE = "raster.native-node";
  var RASTER_NATIVE_CONTAINER_TYPE = "raster.native-container";
  var fabricNodeChildHandles = /* @__PURE__ */ new WeakMap();
  var textControlEventCounts = /* @__PURE__ */ new Map();
  var TEXT_EVENT_COUNT_PROP = "__rasterTextEventCount";
  var fabricNodeShadows = /* @__PURE__ */ new WeakMap();
  var fabricMaterializeDiagnostics = {
    lastVisitedNodes: 0,
    lastEmittedNodes: 0,
  ...
  function handlerSlotKey(surfaceId, nodeTag, kind, name) {
    return `${surfaceId}:${nodeTag}:${kind}:${name}`;
  }
  function handlerSlotKeyForDescriptor(descriptor) {
  ...
  function textControlKey(surfaceId, nodeTag) {
    return `${surfaceId}:${nodeTag}`;
  }
  function isTextControlType(type) {
    return type === "Input" || type === "Textarea";
  }
  function normalizeTextEventPayload(payload) {
  ...
  function recordTextControlEventCount(record, payload) {
  ...
  function userPayloadForHandler(record, payload) {
    if (record.name !== "onChangeText") {
      return payload;
    }
    return normalizeTextEventPayload(payload)?.value ?? payload;
  }
  function updateHandlerRegistry(descriptor, handler, createSlot, updateSlot) {
  ...
  function updateRasterHandlerSlot(descriptor, handler, binding = getRasterNativeBinding()) {
  ...
  function dropRasterHandlerSlotsForNode(surfaceId, nodeTag, binding) {
  ...
  function normalizeJsonObject(value, path, label) {
  ...
  function normalizeJsonValue(value, path, label) {
    if (value === null) {
      return null;
    }
    ...
    if (typeof value === "object") {
      return normalizeJsonObject(value, path, label);
    }
    throw new Error(`Unsupported ${label} at ${path}: expected JSON-like value`);
  }
  function createEventMetadata(eventType) {
    if (eventType == null) {
      return null;
    }
    return {
  ...
  function getRasterNativeBinding() {
  ...
  function createFabricContainer(options, binding = getRasterNativeBinding()) {
    return {
  ...
  function nativeNodeDebug(name, key) {
    return key == null ? { name } : { name, key };
  }
  function createNativeNodeWrapper(kind, handle, debug, childHandles = [], shadow) {
    const node = {
  ...
  function readFabricChildHandles(instance) {
    return [...fabricNodeShadows.get(instance)?.childHandles ?? fabricNodeChildHandles.get(instance) ?? []];
  }
  function appendInitialFabricChild(parent, child, binding = getRasterNativeBinding()) {
  ...
  function nativeKindForHostType(type) {
    switch (type) {
      case "Input":
        return "input";
      case "Textarea":
  ...
  var fabricReservedProps = /* @__PURE__ */ new Set(["children", "key", "ref", "style", "queries"]);
  function normalizeFabricProps(type, props) {
    const result = {};
    for (const [key, value] of Object.entries(props ?? {})) {
      if (fabricReservedProps.has(key) || value === void 0 || typeof value === "function") {
        continue;
      }
  ...
  function normalizeFabricStyle(type, props) {
    return normalizeJsonValue(props?.style ?? {}, "style", `${type} style`);
  }
  function normalizeFabricContext(type, props) {
  ...
  function normalizeFabricBasePayload(type, props, hidden = false) {
    const payload = {
  ...
  function attachTextControlEventCount(payload, surfaceId, nodeTag, type, props) {
  ...
  function normalizeFabricTextPayload(text, hidden = false) {
    return {
      props: {},
      style: {},
      text: String(text),
  ...
  function collectFabricHandlers(props) {
    ...
    for (const [key, value] of Object.entries(props ?? {})) {
      ...
      if (key === "queries") {
        ...
        for (const [queryName, queryHandler] of Object.entries(value)) {
  ...
  function hasFabricHandlers(props) {
    return collectFabricHandlers(props).length > 0;
  }
  function attachFabricHandlerBindings(payload, surfaceId, nodeTag, props, binding) {
    const events = [];
    const queries = [];
  ...
  function normalizeFabricPayloadForNode(surfaceId, nodeTag, type, props, hidden, binding) {
  ...
  function createFabricHostNode(surfaceId, type, props, key = null, binding = getRasterNativeBinding()) {
    ...
    return createNativeNodeWrapper(kind, handle, nativeNodeDebug(type, key), [], {
      ...
      childrenDirty: false,
      dirtyChildIndexes: /* @__PURE__ */ new Set(),
      committed: true
    });
  }
  function createFabricTextNode(surfaceId, text, binding = getRasterNativeBinding()) {
  ...
  function prepareFabricCommit(container, binding = getRasterNativeBinding()) {
    binding.prepareForCommit(container.surfaceId);
  }
  function resetFabricCommit(container, binding = getRasterNativeBinding()) {
    binding.resetAfterCommit(container.surfaceId);
  }
  function clearFabricSurface(container, binding = getRasterNativeBinding()) {
    binding.clearSurface?.(container.surfaceId);
  }
  function appendFabricChild(parent, child, binding = getRasterNativeBinding()) {
    binding.appendChild(parent.handle, child.handle);
  }
  function appendFabricChildToContainer(container, child, binding = getRasterNativeBinding()) {
    binding.appendChildToContainer(container.surfaceId, child.handle);
  }
  function insertFabricChildBefore(parent, child, before, binding = getRasterNativeBinding()) {
    binding.insertBefore(parent.handle, child.handle, before.handle);
  }
  function insertFabricChildInContainerBefore(container, child, before, binding = getRasterNativeBinding()) {
    binding.insertInContainerBefore(container.surfaceId, child.handle, before.handle);
  }
  function removeFabricChild(parent, child, binding = getRasterNativeBinding()) {
    binding.removeChild(parent.handle, child.handle);
  }
  function removeFabricChildFromContainer(container, child, binding = getRasterNativeBinding()) {
    binding.removeChildFromContainer(container.surfaceId, child.handle);
  }
  function updateFabricHostNode(instance, type, props, hidden = false, binding = getRasterNativeBinding()) {
    binding.updateNode(
      instance.handle,
  ...
  function updateFabricTextNode(instance, text, binding = getRasterNativeBinding()) {
    binding.updateTextNode(instance.handle, String(text));
  }
  function readRasterFabricMaterializeDiagnostics() {
    return { ...fabricMaterializeDiagnostics };
  }
  function resetRasterFabricMaterializeDiagnostics() {
  ...
  function deleteFabricNode(instance, binding = getRasterNativeBinding()) {
  ...
  rasterGlobal.__rasterInvokeHandler = function(id, payload) {
    ...
    const result = typeof rasterGlobal.__rasterRunEvent === "function" ? rasterGlobal.__rasterRunEvent(
      record.handler,
      userPayload,
  ...
  rasterGlobal.__rasterInvokeHandlerJson = function(id, payloadJson) {
    return rasterGlobal.__rasterInvokeHandler?.(id, JSON.parse(payloadJson));
  };
  rasterGlobal.__rasterInvokeHandlersJson = function(callsJson) {
    ...
    for (const { call, record } of resolvedCalls) {
      ...
      results.push(
        typeof rasterGlobal.__rasterRunEvent === "function" ? rasterGlobal.__rasterRunEvent(
          record.handler,
          userPayload,
          createEventMetadata(record.eventType)
        ) : record.handler(userPayload)
  ...
  rasterGlobal.__rasterInvokeQuery = function(id, payload) {
    const record = handlers.get(id);
    if (!record) {
      return void 0;
    }
  ...
  rasterGlobal.__rasterInvokeQueryJson = function(id, payloadJson) {
    const result = rasterGlobal.__rasterInvokeQuery?.(id, JSON.parse(payloadJson));
    return JSON.stringify(result ?? null);
  };
  rasterGlobal.__rasterHasHandler = function(id) {
  ...
  // src/react/index.ts
  var rasterGlobal2 = globalThis;
  var rasterEventGlobal = globalThis;
  var NotPendingTransition = null;
  var HostTransitionContext = (0, import_react.createContext)(
    NotPendingTransition
  );
  var rootHostContext = {};
  var NO_EVENT_TIMESTAMP = -1.1;
  var NOOP_DEFAULT_TRANSITION_INDICATOR = () => {
  };
  var noFormatConsoleMethods = /* @__PURE__ */ new Set(["dir", "dirxml", "groupEnd", "table"]);
  var currentUpdatePriority = import_constants.NoEventPriority;
  var currentRasterEvent = null;
  var schedulerEvent = null;
  var currentFabricSurfaceId = null;
  function rendererVersion() {
    const version = rasterGlobal2.__rasterRendererVersion;
  ...
  function bindConsoleMethod(methodName, args, environmentName = "unknown") {
    ...
    if (noFormatConsoleMethods.has(methodName)) {
      return bind.apply(consoleMethod, [console, ...args]);
    }
    const badgeFormat = "[%s]";
    ...
    return bind.apply(consoleMethod, [console, ...nextArgs]);
  }
  function createFabricContainerForHostConfig(options) {
    return createFabricContainer(options, getRasterNativeBinding());
  }
  function createFabricInstance(type, props, rootContainer, _hostContext, internalHandle) {
  ...
  var commonHostConfig = {
    ...
    resolveUpdatePriority() {
      return currentUpdatePriority === import_constants.NoEventPriority ? import_constants.DefaultEventPriority : currentUpdatePriority;
    },
    trackSchedulerEvent() {
      schedulerEvent = currentRasterEvent;
    },
    resolveEventType() {
      return currentRasterEvent && currentRasterEvent !== schedulerEvent ? currentRasterEvent.type : null;
    },
    resolveEventTimeStamp() {
      return currentRasterEvent && currentRasterEvent !== schedulerEvent ? currentRasterEvent.timeStamp : NO_EVENT_TIMESTAMP;
    },
    ...
    bindToConsole(methodName, args, environmentName) {
      return bindConsoleMethod(methodName, args, environmentName);
    },
    NotPendingTransition,
    HostTransitionContext
  };
  var fabricHostConfig = {
    ...commonHostConfig,
  ...
  var fabricReconciler = (0, import_react_reconciler.default)(fabricHostConfig);
  var currentEventReconciler = fabricReconciler;
  function flushRasterWork(reconciler = currentEventReconciler) {
  ...
  function createFabricReconcilerContainer(containerInfo) {
    const tag = import_constants.ConcurrentRoot;
  ...
  function createFabricRoot(options) {
  ...
  function createRoot(options) {
    if (rasterGlobal2.__rasterDevReload === true) {
      if (rasterGlobal2.__rasterDevRoot == null) {
        rasterGlobal2.__rasterDevRoot = createFabricRoot(options);
      }
      return rasterGlobal2.__rasterDevRoot;
    }
    return createFabricRoot(options);
  }
  rasterGlobal2.__rasterPrepareDevReload = () => {
    rasterGlobal2.__rasterDevRoot?.clear();
  };
  rasterGlobal2.__rasterFlushSyncWork = () => {
    flushRasterWork(currentEventReconciler);
  };
  rasterGlobal2.__rasterRunEvent = (handler, payload, event) => {
  ...
  function ConfigProvider({
    ...
    return (0, import_jsx_runtime.jsx)("ConfigProvider", {
      theme,
      text,
      resources,
      children,
  ...
  function Widget({ name, props = {}, queries = {}, style, children, ...events }) {
  ...
  function nativeBinding() {
    const binding = globalThis.__rasterNative;
    if (binding == null) {
  ...
  function createComponent(name) {
    ...
    function RasterComponent(input) {
      const { props, style, children, events, queries } = splitComponentProps(input);
      return (0, import_jsx_runtime2.jsx)(Widget, {
        name,
        props,
        queries,
        style,
  ...
  var Avatar = createComponent("Avatar");
  var AvatarGroup = createComponent("AvatarGroup");
  var Alert = createComponent("Alert");
  var Button = createComponent("Button");
  var ButtonGroup = createComponent("ButtonGroup");
  var Checkbox = createComponent("Checkbox");
  var ColorPicker = createComponent("ColorPicker");
  var DatePicker = createComponent("DatePicker");
  var Dialog = createComponent("Dialog");
  function chartNativeHandle(hostRef) {
  ...
  function chartRows(rowOrRows) {
    return Array.isArray(rowOrRows) ? rowOrRows : [rowOrRows];
  }
  function createChartComponent(name) {
    const ChartComponent = (0, import_react2.forwardRef)((input, ref) => {
  ...
  var LineChart = createChartComponent("LineChart");
  var BarChart = createChartComponent("BarChart");
  var AreaChart = createChartComponent("AreaChart");
  var PieChart = createChartComponent("PieChart");
  var CandlestickChart = createChartComponent("CandlestickChart");
  var FieldHost = createComponent("Field");
  function Field({
    validate,
    ...
    (0, import_react2.useEffect)(() => {
      ...
      const timeout = setTimeout(() => {
        ...
        globalThis.__rasterFlushSyncWork?.();
      }, delay);
      return () => {
    ...
    const hostProps = resolvedDescription === void 0 ? { ...input, value, __validationError: errorMessage != null } : {
      ...input,
      value,
      description: resolvedDescription,
      __validationError: errorMessage != null
    };
    return (0, import_jsx_runtime2.jsx)(FieldHost, {
      ...hostProps
    });
  }
  var Form = createComponent("Form");
  var Icon = createComponent("Icon");
  var Radio = createComponent("Radio");
  var RadioGroup = createComponent("RadioGroup");
  var Select = createComponent("Select");
  var Sheet = createComponent("Sheet");
  var Switch = createComponent("Switch");
  var Tab = createComponent("Tab");
  var TabBar = createComponent("TabBar");
  var VirtualListHost = createComponent("VirtualList");
  function VirtualList({
    ...
    const renderedChildren = renderItem == null || items == null ? children : items.map((item, index) => {
    ...
    return (0, import_jsx_runtime2.jsx)(VirtualListHost, {
      ...input,
  ...
  return __toCommonJS(runtime_bundle_exports);
})();
...
react/cjs/react-jsx-runtime.production.js:
   ...
   *)
*/
globalThis.__RasterBundle = __RasterBundle;
