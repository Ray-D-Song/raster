...
pub struct RasterRuntimeHexModule;

impl RasterRuntimeHexModule {
...
impl ModuleDef for RasterRuntimeHexModule {
...
impl From<RasterRuntimeHexModule> for ModuleInfo<RasterRuntimeHexModule> {
    fn from(val: RasterRuntimeHexModule) -> Self {
        ModuleInfo {
            name: "raster_runtime:hex",
            module: val,
        }
    }
}
