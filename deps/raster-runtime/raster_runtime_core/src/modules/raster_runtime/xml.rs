...
pub struct RasterRuntimeXmlModule;

impl ModuleDef for RasterRuntimeXmlModule {
...
impl From<RasterRuntimeXmlModule> for ModuleInfo<RasterRuntimeXmlModule> {
    fn from(val: RasterRuntimeXmlModule) -> Self {
        ModuleInfo {
            name: "raster_runtime:xml",
            module: val,
        }
    }
}
