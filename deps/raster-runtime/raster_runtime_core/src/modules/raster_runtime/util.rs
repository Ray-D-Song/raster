...
pub struct RasterRuntimeUtilModule;

impl ModuleDef for RasterRuntimeUtilModule {
...
impl From<RasterRuntimeUtilModule> for ModuleInfo<RasterRuntimeUtilModule> {
    fn from(val: RasterRuntimeUtilModule) -> Self {
        ModuleInfo {
            name: "raster_runtime:util",
            module: val,
        }
    }
}
