...
#[cfg(unix)]
use raster_runtime_utils::signals::{kill, signal_str_from_i32};

#[cfg(not(unix))]
use raster_runtime_utils::signals::{kill_process_raw, parse_signal};
...
mod tests {
    ...
    use raster_runtime_test::{test_async_with, ModuleEvaluator};
