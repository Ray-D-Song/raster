...
pub struct RasterRuntimeQjsModule;

impl ModuleDef for RasterRuntimeQjsModule {
...
impl From<RasterRuntimeQjsModule> for ModuleInfo<RasterRuntimeQjsModule> {
    fn from(val: RasterRuntimeQjsModule) -> Self {
        ModuleInfo {
            name: "raster_runtime:qjs",
            module: val,
        }
    }
}
