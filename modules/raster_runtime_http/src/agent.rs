...
use raster_runtime_utils::{any_of::AnyOf4, bytes::ObjectBytes, object::ObjectExt};
...
impl Agent {
    ...
    pub fn new<'js>(ctx: Ctx<'js>, options: Opt<AgentOptions>) -> Result<Self> {
        ...
        let config =
            raster_runtime_tls::build_client_config(raster_runtime_tls::BuildClientConfigOptions {
                reject_unauthorized,
                ca,
            })
